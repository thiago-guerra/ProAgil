...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProAgil.Domain.Identity.Roles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProAgil.Domain.Identity.UserRoles", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ProAgil.Domain.Identity.Roles")
                        .WithMany()
            ...
            modelBuilder.Entity("ProAgil.Domain.Identity.UserRoles", b =>
                {
                    b.HasOne("ProAgil.Domain.Identity.Roles", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
